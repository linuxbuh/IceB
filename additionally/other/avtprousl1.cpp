/*$Id: avtprousl1.c,v 5.5 2011-01-13 13:43:21 sasa1 Exp $*/
/*17.06.2009	14.04.2009	Белых А.И.	avtprousl1.c
...
zapmpr1(nomdok,avp.kodop.ravno(),podr,time(NULL),gettext("УСЛ"),dd,md,gd,tipz,&sp_prov,&sum_prov_dk,ff_prot);
