...
/*26.10.2013	14.04.2009	Белых А.И.	iceb_t_avp.c
...
/*****************/
int iceb_t_avp_provsh(const char *shet,const char *kontr_v_dok,class iceb_tu_str *shetv,class iceb_tu_str *kontrv,FILE *ff_prot)
{
...
if(kolp == 0)
 {
  return(iceb_t_avp_provsh(shet,kontr_v_dok,shetv,kontr,ff_prot));
...
return(iceb_t_avp_provsh(shet_menu.ravno(),kontr_menu.ravno(),shetv,kontr,ff_prot));
