/*$Id: period.c,v 5.6 2013/05/17 14:56:42 sasa Exp $*/
/*16.12.2009    22.06.1994      Белых А.И.      period.c
Определение количества дней между двумя датами или месяцев
Возвращает количество дней или месяцев
*/
#include	"util.h"

short           period(short dn,short mn,short gn, //Начальная дата (меньшая)
short dk,short mk,short gk, //Конечная дата (большая)
short met) //0-количество дней 1-количество месяцев
{
short           d,m,g;
int             kold;
