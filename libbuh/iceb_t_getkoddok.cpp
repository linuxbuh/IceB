/*$Id:$*/
/*06.12.2018	18.12.2014	Белых А.И.	iceb_t_getkoddok.c
получить код документа в формате xml
*/
#include "buhl.h"

const char *iceb_t_getkoddok(short d,short m,short g,
...
//   strcpy(kod_nn,"J1201009");
  ...
  case 2: /*Реестр налоговых накладных*/
   ...
   if(sravmydat(d,m,g,1,3,2013) < 0)
    strcpy(kod_nn,"J1201505");
   
   if(sravmydat(d,m,g,1,3,2013) >= 0 && sravmydat(d,m,g,1,1,2014) < 0)
    strcpy(kod_nn,"J1201506");
   
   if(sravmydat(d,m,g,1,1,2014) >= 0 && sravmydat(d,m,g,1,12,2014) < 0)
    strcpy(kod_nn,"J1201507");

   if(sravmydat(d,m,g,1,12,2014) >= 0)
