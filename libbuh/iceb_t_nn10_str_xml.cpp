...
/*06.12.2018	17.03.2016	Белых А.И.	iceb_t_nn10_str_xml.c
...
void iceb_t_nn10_str_xml(int nomer,double kolih,double cena,double suma,const char *ei,
