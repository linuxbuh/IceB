/*$Id: iceb_t_rnn_sap_xml.c,v 5.3 2013/12/31 11:48:20 sasa Exp $*/
/*18.12.2014	13.10.2006	Белых А.И.	rnn_sap_xml.c
Шапка документов в xml формате
*/
#include "buhl.h"

void iceb_t_rnn_sap_xml(short mn,short gn,short mk,
const char *kod_dok,
int pnd,
...
void iceb_t_rnn_sap_xml(short mn,short gn,short mk,const char *tip_dok,
const char *podtip,
int type_ver,
int pnd,
const char *imaf,
