/*$Id: iceb_t_pvkdd.c,v 5.8 2013-04-07 10:22:54 sasa Exp $*/
/*17.11.2008	22.04.2008	Белых А.И.	iceb_t_pvkdd.c
...
if(iceb_t_pvglkni(md,gd) != 0)
 return(1);

if(iceb_t_pvglkni(mk,gk) != 0)
 return(1);
...
while(cur.read_cursor(&row) != 0)
 {
  ...
  if(iceb_t_pbsh(md,gd,row[0],row[1],"") != 0)
   return(1);

  if(iceb_t_pbsh(mk,gk,row[0],row[1],"") != 0)
   return(1);
 }
