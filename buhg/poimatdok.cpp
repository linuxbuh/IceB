/* $Id: poimatdok.c,v 5.18 2013/08/13 05:49:50 sasa Exp $ */
/*23.05.2013	11.01.2000	Белых А.И.	poimatdok.c
...
sprintf(strsql,"select datd,sklad,nomd,kontr,kodop,pod,pro,tip from Dokummat where nomd='%s' \
...
for(i=0; i < kls ;)
 {
  ...
  sprintf(strsql,"%02d.%02d.%d|%-4s|%-*s|%-*s|%-*s|%s",
  dd,md,gd,
  row[1],
