/* $Id: poiuosdok.c,v 5.19 2013/08/13 05:49:50 sasa Exp $ */
/*23.05.2013	11.01.2000	Белых А.И.	poiuosdok.c
...
if(vvod1(&nomdok,32,&VVOD1,NULL,stdscr,-1,-1) == FK10)
  return;
if(nomdok.ravno()[0] == '\0')
  return;
...
sprintf(strsql,"select datd,podr,nomd,kontr,kodop,podt,prov,tipz from Uosdok where nomd='%s' \
