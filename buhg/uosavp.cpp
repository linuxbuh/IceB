/*$Id:$*/
/*19.12.2019 	15.05.2017	Белых А.И.	uosavp.cpp
...
if(readkey(strsql,&row,&cur) == 1)
 { 
  ...
  class iceb_tu_str kodol_fio("");
  class iceb_tu_str kodol_dolg("");
  class iceb_tu_str kodolv_fio("");
  class iceb_tu_str kodolv_dolg("");
