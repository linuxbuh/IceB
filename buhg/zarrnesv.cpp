/*$Id: zarrnesv.c,v 5.11 2014/01/31 12:11:34 sasa Exp $*/
/*17.05.2015	26.01.2011	Белых А.И.	zarrnesv.c
...
int kod_esv_vs=0; /*Код удержания единого социального взноса для военнослужащих*/
...
int kodf_esv_vs=0;  /*код фонда удержания единого социального взноса с военнослужащих*/
...
class iceb_tu_str kod_dop_nah_bol; /*коды начилений дополнительно входящие в расчёт удержания ЕСВ с больничного*/
...
iceb_t_poldan("Код удержания единого социального взноса с больничных для инвалидов",&kod_esv_bol_inv,"zarnast.alx");
...
iceb_t_poldan("Код фонда единого социального взноса с больничных для инвалидов",&kodf_esv_bol_inv,"zarnast.alx");
...
iceb_t_poldan("Коды начислений дополнительно входящие в расчёт удержания ЕСВ для больничных",&kod_dop_nah_bol,"zarnast.alx");


gchar *strsql=g_strdup_printf("%s-Прочитали настройки\n\
