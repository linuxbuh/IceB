/*$Id: zvb_ukrgaz.c,v 5.9 2013/08/13 05:50:04 sasa Exp $*/
/*30.06.2013	22.10.2009	Белых А.И.	zvb_ukrgaz.c
...
void zvb_ukrgaz(short prn,const char *zapros,struct dirnupoi *poisk)
{
char strsql[512];
char imafr[64];
char imaf_dbf[64];
...
if(zvb_ukrgaz_start(imafr,imaf_dbf,imaf_dbf_tmp,&ff_dbf_tmp,&ffr) != 0)
 return;
...
while(cur.read_cursor(&row) != 0)
 {
  ...
  zvb_ukrgaz_str(++nomer_zap,fio.ravno(),kartshet.ravno(),suma,inn.ravno(),row[1],ff_dbf_tmp,ffr);


    
 }

zvb_ukrgaz_end(imaf_dbf,imaf_dbf_tmp,sumai,nomer_zap,ffr,ff_dbf_tmp);
