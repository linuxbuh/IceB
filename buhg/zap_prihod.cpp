/*$Id:$*/
/*22.03.2017	19.02.2005	Белых А.И.	zap_prihod.c
Запись в приходный документ материального учёта
*/
#include "buhg.h"


void zap_prihod(const char *datdok,
const char *nomdok,
int sklad,
int kodmat,
double kolih,
...
zap_prihod(dd,md,gd,nomdok,sklad,kodmat,kolih,cena,eiz,shetu,nds,vtara,mnds,nomzak,shet_sp);
}
/****************************************************/
void zap_prihod(short dd,short md,short gd,
const char *nomdok,
int sklad,
int kodmat,
double kolih,
...
if(nomkar == 0)
 {
  nomkar=nomkr(sklad);
  if(zapkar(sklad,nomkar,kodmat,cena,eiz,shetu,krt,fas,kodt,nds,mnds,0.,0,0,0,"","","",0,0,0,0) != 0)
    return;
 }

zapvdok(dd,md,gd,sklad,nomkar,kodmat,nomdok,kolih,cena,eiz,nds,mnds,vtara,tipz,0,shet_sp,nomzak,0,"");
