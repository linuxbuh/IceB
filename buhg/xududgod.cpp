/*$Id: xududgod.c,v 5.3 2013/09/26 09:43:44 sasa Exp $*/
/*15.11.2012	15.11.2012	Белых А.И.	xududgod.c
...
sprintf(strsql,"select udb,udn from icebuser where login='%s'",iceb_tu_getlogin());
...
sprintf(strsql,"delete from Uddok1 where datd >= '%04d-01-01' and datd <= '%04d-12-31'",god,god);
...
sprintf(strsql,"delete from Uddok where datd >= '%04d-01-01' and datd <= '%04d-12-31'",god,god);
