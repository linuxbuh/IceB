/*$Id: repair_table.c,v 5.1 2012-11-29 09:48:57 sasa Exp $*/
/*15.07.2015	06.10.2012	Белых А.И.	repair_table.c
...
printw("%s %s\n",gettext("Восстановление таблиц базы данных"),namebase);


VVOD DANET(1);

DANET.VVOD_SPISOK_add_MD(gettext("Восстановить таблицы ? Вы уверены ?"));
...
iceb_t_zagolov(gettext("Восстановление таблиц базы данных"),ff_prot);
fprintf(ff_prot,"\n");
int kolstr1=0;
...
oth->spis_naim.plus(gettext("Протокол восстановления"));
