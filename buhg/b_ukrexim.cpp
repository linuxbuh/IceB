/*$Id: b_ukrexim.c,v 5.10 2013-01-02 10:38:36 sasa Exp $*/
/*15.03.2011	20.09.2006	Белых А.И.	b_ukrexim.c
...
***********/
  ...
  iceb_tu_ekrs(koment_f,sizeof(koment_f),'\\',"\"");
 ...
 \"%02d.%02d.%d\"\n",
  ...
  iceb_tu_kolbait(38,naior),naior,
  rec.kod.ravno(),
  iceb_tu_kolbait(38,naiban),naiban,
  atoi(rec.mfo.ravno()),
  rec.nsh.ravno(),
  iceb_tu_kolbait(38,naior1),naior1,
  rec.kod1.ravno(),
  iceb_tu_kolbait(38,naiban1),naiban1,
  atoi(rec.mfo1.ravno()),
  rec.nsh1.ravno(),
  "980",
  rec.sumd,
  0.,
  iceb_tu_kolbait(160,koment_f),koment_f,
  rec.dd,rec.md,rec.gd);
